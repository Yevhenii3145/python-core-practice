task = """Напомним, что в 4 модуле мы для кулинарного блога писали
функцию format_ingredients, которая принимала на вход список из
ингредиентов рецепта.
Мы продолжим работать в этом направлении и создадим функцию, которая
будет искать рецепт в файле и возвращать найденный рецепт в виде словаря
определенной формы.
...
Должен найти в файле строку 60b90c3b13067a15887e1ae4,Watermelon Cucumber Salad,
1 large seedless watermelon,12 leaves fresh mint,1 cup crumbled feta cheese и
вернуть результат в виде словаря такой структуры:
{
...
print(get_recipe("task_6.txt", "60b90c3b13067a15887e1ae4"))
