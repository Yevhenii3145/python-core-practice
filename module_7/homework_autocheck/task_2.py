...
task="""Модифицируем пример предыдущей задачи. Для функции do_setup
необходимо предусмотреть второй параметр, который будет являться списком
зависимостей.
Функция do_setup(args_dict, requires) должна вызывать функцию setup с параметрами
