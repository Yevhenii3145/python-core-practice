task = """Реализуйте все методы сравнения для класса Vector. В целях упрощения
сравнивать экземпляры класса Vector будем только по их длине, используя метод len,
не учитывая направление векторов.
